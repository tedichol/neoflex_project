...
CREATE OR REPLACE PROCEDURE ds.init_account_balance_f() AS $$
    ...
    BEGIN
        ...
        INSERT INTO dm.dm_account_balance_f
            ...
            --легко путаться с таким количеством счетов, когда только по 112 из которых
            ...
            --  требуется брать откуда-то еще, кроме таблицы ds.md_account_d, для которой
            --  все остатки определены в ds.ft_balance_f, но такого действия не обозначается
